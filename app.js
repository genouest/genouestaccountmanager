...
app.post('/database/request/:id', database);
app.post('/database/declare/:id', database);
app.post('/database/create/:id', database);
...
app.post('/project/:id/request/user', projects);
app.post('/project/:id/add/manager/:uid', projects);
app.post('/project/:id/remove/manager/:uid', projects);
